...
public class CommentAnnotation_Type extends Annotation_Type{
    ...
    /** @generated
     @modifiable */
    @SuppressWarnings ("hiding")
    public final static boolean featOkTst = JCasRegistry.getFeatOkTst("type.CommentAnnotation");
    ...
    public String getGoldValue(int addr) {
      ...
      jcas.throwFeatMissing("goldValue", "type.CommentAnnotation");
    ...
    public String getPredictValue(int addr) {
      ...
      jcas.throwFeatMissing("predictValue", "type.CommentAnnotation");
